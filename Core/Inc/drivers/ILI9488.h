...
#define CS_PIN		GPIO_PIN_15 //Chip select
#define RESX_PORT	GPIOB
#define RESX_PIN	GPIO_PIN_13 //Reset pin
#define	DC_PORT		GPIOB
#define DC_PIN		GPIO_PIN_14 //DATA / Command select
#define WR_PORT		GPIOB
#define	WR_PIN		GPIO_PIN_12 //Write pin
#define RD_PORT		GPIOB
#define	RD_PIN		GPIO_PIN_11 //Read pin
